...
public class DataProviderUnblocked {
    ...
    public DataProviderUnblocked(String nomor_polisi,String nama_sppbe, String status_izin,String deadline,String unblock_requester){
    ...
    public String getNotification(){
        String notification = "Skidtank Nomor Polisi <b>"+getNomor_polisi()+"</b> milik <b>"+getNama_sppbe()+"</b> telah di-unblock .";
        return notification;
    }
