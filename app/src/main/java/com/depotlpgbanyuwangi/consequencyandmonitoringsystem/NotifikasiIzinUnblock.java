...
public class NotifikasiIzinUnblock extends AppCompatActivity {

    RecyclerView recyclerView;
    RecyclerView.Adapter adapter;
    RecyclerView.LayoutManager layoutManager;
    String [] nomor_polisi, nama_sppbe, status_izin, deadline, unblock_requester;
    ArrayList<DataProviderIzinUnblock> arrayList = new ArrayList<DataProviderIzinUnblock>();
    private Handler mHandler = new Handler();
    String notifikasi_url = "http://depotlpgbanyuwangi.com/notifikasi_izin_unblock.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notifikasi_izin_unblock);
        mHandler.postDelayed(refresh, 250);
    }

    public void onBackPressed(){
        Intent intent = new Intent(NotifikasiIzinUnblock.this, AdminArea.class);
    ...
    private Runnable refresh = new Runnable() {
        ...
        public void run() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if(code.equals("notifikasi_failed")){
                            Toast.makeText(NotifikasiIzinUnblock.this,jsonObject.getString("message"),Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(NotifikasiIzinUnblock.this,jsonObject.getString("message"),Toast.LENGTH_SHORT).show();
                            ...
                            for(String name : nomor_polisi){
                                ...
                                //System.out.println(name+" "+nama_sppbe[i]+" "+status_izin[i]+" "+deadline[i]+" "+unblock_requester[i]);
                                 DataProviderIzinUnblock dataProviderIzinUnblock = new DataProviderIzinUnblock(name,nama_sppbe[i],status_izin[i],deadline[i],unblock_requester[i]);
                                arrayList.add(dataProviderIzinUnblock);
                                i++;

                            }

                            adapter = new RecyclerAdapterIzinUnblock(arrayList,NotifikasiIzinUnblock.this);
                            recyclerView.setHasFixedSize(true);
                            //System.out.println("Masuk Pak Eko");
                            layoutManager = new LinearLayoutManager(NotifikasiIzinUnblock.this);
            ...
            MySingleton.getmInstance(NotifikasiIzinUnblock.this).addToRequestQueue(stringRequest);
        }
    };
