...
public class DataProviderHistoryChecker {
    ...
    public DataProviderHistoryChecker(String checkername, String IDcek, String waktucek, String nopolcek, String milikcek){
